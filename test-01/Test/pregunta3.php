                    ...
                    <input type="hidden" name="Pregunta2" value=<?php echo $_POST['Pregunta2']; ?>>
                        <div class="row">
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta3" value="0" required>
                                <label class="form-check-label">No</label>
                            </div>
                            <div class="col-12  respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta3" value="1" required> 
                                <label class="form-check-label">Leve</label>
                            </div>
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta3" value="2" required>
                                <label class="form-check-label">Moderado</label>
                            </div>
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta3" value="3" required>
