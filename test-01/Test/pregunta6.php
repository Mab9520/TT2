...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Mareado o que se le va la cabeza</h2>
            </div>
        </div>
    </div>
    <div class="container">
                    ...
                    <form action="pregunta7.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta6" value="0" required>
                                <label class="form-check-label">No</label>
                            </div>
                            <div class="col-12  respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta6" value="1" required> 
                                <label class="form-check-label">Leve</label>
                            </div>
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta6" value="2" required>
                                <label class="form-check-label">Moderado</label>
                            </div>
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta6" value="3" required>
