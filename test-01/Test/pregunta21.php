...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Con sudores fríos o calientes</h2>
            </div>
        </div>
    </div>
    <div class="container">
                    ...
                    <form action="ans.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta21" value="0" required>
                                <label class="form-check-label">No</label>
                            </div>
                            <div class="col-12  respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta21" value="1" required> 
                                <label class="form-check-label">Leve</label>
                            </div>
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta21" value="2" required>
                                <label class="form-check-label">Moderado</label>
                            </div>
                            <div class="col-12 respuesta">
                                <input class="form-check-input" type="radio" name="Pregunta21" value="3" required>
